    ...
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="grid-wrap">
            <ul class="row grid">
                ...
                <li>
                    <figure>
                        <img src="{{ asset('img/projects/project-7.jpg') }}" alt="Portolio Image">
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('img/projects/project-8.jpg') }}" alt="Portolio Image">
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('img/projects/project-9.jpg') }}" alt="Portolio Image">
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
            ...
            <ul>
                    ...
                    <figure>
                        ...
                        <div id="slider" class="carousel slide portfolio-slider" data-ride="carousel" data-interval="false">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ asset('img/projects/project-1.jpg') }}" alt="slide 3">
                                </div>
                            </div>
                        </div>
                        <!-- Main Project Content Ends -->
                ...
                <li>
                    <figure>
                        ...
                        <!-- Project Details Ends -->
                        <!-- Main Project Content Starts -->
                        <video id="video" class="responsive-video" controls="" poster="{{ asset('img/projects/project-1.jpg') }}">
