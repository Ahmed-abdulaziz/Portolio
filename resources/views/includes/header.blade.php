...
<head>
    ...
    <link href="{{ asset('fonts/css.css?family=Poppins:400,400i,500,500i,600,600i,700,700i,800,800i,900,900i') }}" rel="stylesheet">
    <link href="{{ asset('fonts/css-1.css?family=Open+Sans:300,400,400i,600,600i,700') }}" rel="stylesheet">
